...
class ConnectionStateStatusBarItem(object):
    def __init__(self):
        ...
        self._ebox = gtk.EventBox()
        self._align = gtk.Alignment(1, 0.5, 0, 0)
        self._ebox.add(self._align)
        ...
        self._connected_icon.set_from_stock(gtk.STOCK_CONNECT,
                                            gtk.ICON_SIZE_MENU)
        self._connected_box.pack_start(self._connected_icon, False, False, 2)
        self._connected_label = gtk.Label()
#        self._connected_label.set_alignment(xalign=1, yalign=0.5)
        self._connected_label.set_text(_("Connected"))
        self._connected_box.pack_start(self._connected_label, False, False, 2)
        self._align.add(self._connected_box)
        ...
        self._disconnected_icon.set_from_stock(gtk.STOCK_DISCONNECT,
                                               gtk.ICON_SIZE_MENU)
        self._disconnected_box.pack_start(self._disconnected_icon, False, False, 0)
...
#        self._connected_label.set_alignment(xalign=1, yalign=0.5)
        ...
        self._align.add(self._disconnected_box)
...
#        self._ebox.add(self._disconnected_box)
        ...
        self._ebox.show_all()
#        self._connected_box.show_all()
#        self._disconnected_box.show_all()
